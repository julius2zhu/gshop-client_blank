    ...
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsUl" style="width: 500px"  >
...
<script>
  ...
  export default {
    ...
    mounted () {
      //不存在才创建,此处是一个同步操作,点击shop的时候ShopInfo已经创建了
      if (!this.srcoll) {
        this.srcoll = new BScroll('.shop-info', {})
        const bScroll = new BScroll('.pic-wrapper', {scrollX: true})
        console.log(bScroll.wrapperWidth)
        console.log(bScroll.scrollerWidth)
      } else {
        this.srcoll.refresh()
      }
    }
